...
from pywikibot import family  # type: ignore[import-not-found]
from pywikibot import pagegenerators  # type: ignore[import-not-found]  
from pywikibot.scripts import generate_family_file  # type: ignore[import-not-found]
from pywikibot.scripts.generate_user_files import pywikibot  # type: ignore[import-not-found]
...
def family_class_dispatch(url: str, name: str) -> type[family.Family]:
    ...
    """
    if "wikipedia" in url:
        import pywikibot.families.wikipedia_family  # type: ignore[import-not-found]
