...
# Simple auth backend enum (Gmail doesn't use this, but keeping for compatibility)
class AuthBackend:
    REDIS = "redis"
    DATABASE = "database"
...
# Simple image analysis constants (Gmail doesn't use these, but keeping for compatibility)
DEFAULT_IMAGE_ANALYSIS_SYSTEM_PROMPT = "Analyze the provided image and describe what you see."
DEFAULT_IMAGE_SUMMARIZATION_SYSTEM_PROMPT = "Summarize the content of the provided image."
DEFAULT_IMAGE_SUMMARIZATION_USER_PROMPT = "Please summarize this image:"
...
AUTH_BACKEND = os.environ.get("AUTH_BACKEND") or AuthBackend.REDIS
