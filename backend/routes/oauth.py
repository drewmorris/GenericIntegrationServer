...
# Lazy imports to avoid test collection issues
...
async def oauth_start(
    ...
    data = {"organization_id": current_user["organization_id"], "user_id": current_user["user_id"], "connector": connector, "next": next}
    if code_verifier:
    ...
    logger.info("oauth_start connector=%s org=%s user=%s next=%s method=%s", connector, current_user["organization_id"], current_user["user_id"], next, additional_kwargs.get("code_challenge_method"))
